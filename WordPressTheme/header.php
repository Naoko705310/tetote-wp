    ...
    <div class="header__inner">
      ...
      <h1 class="header__logo header-logo">
        <a href="<?php echo esc_url(home_url('/')); ?>" class="header-logo__link">
          <!-- 白いロゴ（通常時） -->
          <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/tetote-logo-white.svg')); ?>" alt="TETOTEロゴ" width="250" height="61" class="header-logo__img header-logo__img--white">
          <!-- 黒いロゴ（メニュー開いている時・スクロール時） -->
          <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/tetote-logo.svg')); ?>" alt="TETOTEロゴ" width="250" height="61" class="header-logo__img header-logo__img--black">
        </a>
      </h1>
      <!-- ヘッダーロゴ （最初のコードをコメントアウト）-->
      <!-- <h1 class="header__logo header-logo">
        <a href="<?php echo esc_url(home_url('/')); ?>">
          <img src="<?php echo get_theme_file_uri('/assets/images/common/tetote-logo-white.svg'); ?>" alt="TETOTEロゴ" width="250" height="61">
        </a>
      </h1> -->
      ...
      <nav class="header__buttons header-buttons js-header-buttons">
        <ul>
          <li><a href="<?php echo esc_url(home_url('/details')); ?>" class="button button--entry button--entry-black">募集要項</a></li>
          <li><a href="<?php echo esc_url(home_url('/entry')); ?>" class="button button--entry button--entry-accent">ENTRY</a></li>
        </ul>
      </nav>

      <!-- ハンバーガーメニュー -->
      <button id="hamburger-menu" class="header__hamburger hamburger js-hamburger" aria-label="メニューを開く" aria-expanded="false">
        <span></span>
        <span></span>
        <span></span>
        ...
        <div class="header-nav__contents-wrapper">
          ...
          <div class="header-nav__logo-wrapper">
            <div class="header-nav__logo">
              <a href="<?php echo esc_url(home_url('/')); ?>">
                <img src="<?php echo get_theme_file_uri('/assets/images/common/tetote-logo.svg'); ?>" alt="TETOTEロゴ" width="250" height="61">
              </a>
            </div>
          </div>
          ...
          <div class="header-nav__nav-wrapper">
            ...
            <ul class="header-nav__buttons">
              <li class="header-nav__button">
                <a href="<?php echo esc_url(home_url('/details')); ?>" class="button button--entry button--entry-black js-header-link">募集要項</a>
              </li>
              <li class="header-nav__button">
                <a href="<?php echo esc_url(home_url('/entry')); ?>" class="button button--entry button--entry-accent js-header-link">ENTRY</a>
              </li>
            </ul>
